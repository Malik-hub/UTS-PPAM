...
public class MainActivity extends AppCompatActivity {
    ...
    public void login() {
        ...
        Log.d("print", String.valueOf(username.equals("namague")));
        Log.d("print", String.valueOf(password.equals("password")));
        //Cek apakah username dan password benar
        if (username.equals("namague") && password.equals("password")) {
